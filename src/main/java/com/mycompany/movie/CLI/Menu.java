...
public class Menu {
    ...
    public static void mainMenu(Scanner scanObj, Customer customer) throws ParseException {
        while (true) {
    ...
    public static void addMovie(Scanner scanObj) throws ParseException {
        int id= MovieLibrary.getMovies().getLast().getID()+1;
        ...
        Movie newMovie = new Movie(id , title, genre, screenTimes);
